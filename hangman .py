...
def play(word):
    ...
    print("Let's go playing hangman!")
    while tries>0:     #check attempts number
        print(display_hangman(tries))
        print()
        print(word_completion)
        print()
        print('Number of letters:', len(word_completion))
        print()
        while True:     #check correct choose data input
            ch1 = input('Enter "б" for letter guess, enter "с" for word guess: ')
            print()
            if ch1=='б':
                while True:     #check correct letter data input
                    l=input('Enter letter:  ')
                    print()
                    if l.isalpha() and len(l)==1 and l.upper() not in guessed_letters:
                        l=l.upper()
                        ...
                        continue
                    elif l.upper() in guessed_letters:
                        print('Letter used already')
                        print()
                        continue
                    else:
                        print('Incorrect simbol')
                        print()
                        continue
                if l in word:
                    word_completion1=''
                    for i in range(len(word)):
                        if word[i]==l:
                            ...
                            word_completion1 += word_completion[i]
                        else:
                            word_completion1 += '_'
                    word_completion=word_completion1
                    print(word_completion)
                    print()
                    if '_' not in word_completion:
                        print('Congratulations you guessed the word!'*5, sep='/n')
                        print()
                    ...
                    print()
                    if tries==0:
                        print('Game over, guessed word is: ', word)
                        break
            elif ch1=='с':
                while True:     #check correct word data input
                    print(guessed_words)
                    w=input('Enter word:  ')
                    if w.isalpha() and w.upper() not in guessed_words:
                        w=w.upper()
                        guessed_words.append(w)
                        break
                    elif w.upper in guessed_words:
...
while True:
    ...
    while True:
        ch2=input('Do you want to play again? "д" - yes, "н" - no:  ')
        print()
        if ch2=='д' or ch2=='н':
            break
        else:
